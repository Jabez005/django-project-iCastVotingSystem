...
CSRF_TRUSTED_ORIGINS = ['https://icast.up.railway.app']

CORS_ALLOWED_ORIGINS = [
    'https://icast.up.railway.app',
    'http://localhost',
    'http://127.0.0.1',
]
...
DATABASES = {
       'default': {
         ...
         'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': '*313F3cc52dg2aGCG5EgFEcfa3bBCeGg',
...
#         'NAME': 'railway',
#        'USER': 'postgres',
#        'PASSWORD': 'bABDF6436cd3F*d34bf-46F*BA5AEE4F',
